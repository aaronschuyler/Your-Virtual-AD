    ...
    <div class="org-template">
        <div>
            ...
            <select style="margin:10px;" v-model="div">
                ...
                <option v-for="div in divs" :key="div.divName" :value="div.divName">{{div.divName}}</option>
            </select>
            <button style="margin:10px;" @click="addTeam()" class="theme-button">Add Schedule</button>
        </div>
        <div v-if="teams.length > 0">
            ...
            <div class="team" v-for="(team, index) in teams" :key="team.teamName">
                <table v-if="team.display">
                    <tr>
                        <td>
                            <button class="theme-button" :class="{ active: viewMode[index] }" style="float:left" @click="viewModeChange(index)">
                    ...
                    <tr v-if="addGame[index]" class="add">
                        ...
                        <td>
                            <select @change="getGymsForVS()" name="vs" v-model="newGameVS">
                                <option value="" disabled selected>Select an Opposing Team</option>
                  ...
                  vs
                        ...
                        <td>
                            <select name="site" v-model="newGameSite">
                                ...
                                <option v-for="gs in gss" v-bind:value="gs.gymName" v-bind:key="gs.gymName">{{
                  gs.gymName
                }}</option>
                            </select>
                        </td>
                        <td>
                            <div class="tooltip" v-if="dateTipActive">{{dateTip}} <a @click="dateTipActive = !dateTipActive">close</a></div>
                            <v-date v-model="newGameDate" :disabled-hours="disabledHours" />
                        </td>
                        <td>
                            <button class="theme-button" @click="addPost(teams[index].teamName, index)">
                                <font-awesome-icon style="color:dodgerblue;" icon="plus" />
                            </button>
                        </td>
                    </tr>
                            ...
                            <tr>
                                <td valign="top">
                                    <table>
                                        ...
                                        <tr v-for="(week, indexx) in calcDates(month, year)" :key="indexx">
                                            <td valign="top" :class="{
                          active:
                          ...
                          months[selectedDate.getMonth()] +
                            ...
                            (selectedDate.getYear() + 1900)
                                        ...
                                        <tr v-for="post in posts[index]" :key="post.index">
                                            ...
                                            <td style="text-align:right;" v-if="post.display && checkDate(post.date)">
                                                <button class="theme-button" @click="deletePost(post._id)">
                                                    <font-awesome-icon style="color:red;" icon="trash" />
                                                </button>
                                            </td>
        ...
        watch: {
            newGameDate: function() {
                ...
                for (var i = 0; i < this.disabledDates.length; i++) {
                    if (d.getDate() == this.disabledDates[i].getDate() && d.getMonth() == this.disabledDates[i].getMonth() && d.getYear() == this.disabledDates[i].getYear()) {
